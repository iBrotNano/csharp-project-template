...
```shell
dotnet add package <Package Name> --version 4.7.1.1
```
...
- [#1](https://github.com/iBrotNano/<Package Name>/issues/1) Set the version by an action 
- [#2](https://github.com/iBrotNano/<Package Name>/issues/2) Add issue templates to the repo
- [#3](https://github.com/iBrotNano/<Package Name>/issues/3) Tag the version of a build by an action
